...
{
HX_STACK_PUSH("Layer::new","com/haxepunk/graphics/atlas/AtlasData.hx",26);
{
	HX_STACK_LINE(27)
...
{
		HX_STACK_PUSH("Layer::prepare","com/haxepunk/graphics/atlas/AtlasData.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_LINE(33)
		if (((this->index < this->data->length))){
			HX_STACK_LINE(34)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.haxepunk.graphics.atlas.Layer"), hx::TCanCast< Layer_obj> ,sStaticFields,sMemberFields,
