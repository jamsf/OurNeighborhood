...
const char *__hxcpp_all_files[] = {
	...
	"extendedhxpunk/ext/EXTCamera.hx",
	"extendedhxpunk/ext/EXTColor.hx",
	"extendedhxpunk/ext/EXTConsole.hx",
	"extendedhxpunk/ext/EXTKey.hx",
	"extendedhxpunk/ext/EXTMath.hx",
	"extendedhxpunk/ext/EXTScene.hx",
	"extendedhxpunk/ext/EXTUtility.hx",
	"extendedhxpunk/ui/UIView.hx",
	"extendedhxpunk/ui/UIViewController.hx",
	"flash/Lib.hx",
	"flash/Memory.hx",
	"flash/Vector.hx",
...
const char *__hxcpp_class_path[] = {
	...
	"lib/ExtendedHaxePunk/HaxePunk/",
	"lib/ExtendedHaxePunk/src/",
	"src/",
	"C:\HaxeToolkit/hxlibc/1,1,4/",
	"C:\HaxeToolkit/openfl-native/1,2,2/",
	"C:\HaxeToolkit/openfl/1,2,2/",
