...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING(""),HX_CSTRING("TwoGames"),HX_CSTRING("com.example.app"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",35);
			{
				...
				HX_STACK_LINE(71)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::twogames::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(71)
					while(((_g < _g1->length))){
						HX_STACK_LINE(71)
				...
				if ((hasMain)){
					HX_STACK_LINE(82)
					::Reflect_obj::callMethod(hx::ClassOf< ::twogames::Main >(),::Reflect_obj::field(hx::ClassOf< ::twogames::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(88)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1280,(int)800,(int)30,(int)3355443,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int(::flash::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("TwoGames"),null(),null());
	}
return null();
}
