...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "TwoGames", "com.example.app", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (twogames.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (twogames.Main, Reflect.field (twogames.Main, "main"), []);
...
@:keep class DocumentClass extends twogames.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TwoGames", null, { width: 1280, height: 800 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (twogames.Main, []);
			}
